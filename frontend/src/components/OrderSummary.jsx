...
const stripePromise = loadStripe(
  'pk_test_51QwjbCPGpKxHN7GS4aq2t5qcJyZWdC5Y4WVvHE9vEft6KRP8bjV80DxF2JNEaKGvEiBcd6QgPO82xrOgTr4Oak1l00wMTgiuty'
);
    ...
    >
      ...
      <div className="space-y-4">
        ...
        <motion.button
          ...
          focus:outline-none focus:ring-4 focus:ring-emerald-300 cursor-pointer"
